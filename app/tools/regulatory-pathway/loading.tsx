...
/**
 * Loading state for /tools/regulatory-pathway route
 * Displays classification skeleton while regulatory pathway tool loads
 */
import { ClassificationSkeleton } from '@/components/skeletons';
import Header from '@/components/Header';
import MatrixBackground from '@/components/MatrixBackground';

export default function RegulatoryPathwayLoading() {
    return (
                    ...
                    <div className="mb-8 bg-green-50 border border-green-200 rounded-lg p-6 animate-pulse">
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-1 space-y-3">
                                <div className="h-6 w-64 bg-green-200 rounded" />
